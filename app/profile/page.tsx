  ...
  return (
    <main className="bg-[#f2f2f2] min-h-screen p-[20px] md:p-[22px]">
      <div className="max-w-[1252px] mx-auto flex flex-col gap-10 items-center">
        ...
        <div className="w-full h-auto py-8 md:py-0 md:h-[225px] bg-[#9FB0A5] rounded-[16px] flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-12 relative overflow-hidden gap-4 md:gap-8">
           <div className="w-[80px] md:w-[155px] h-[80px] md:h-[155px] bg-white/30 rounded-full flex items-center justify-center text-white text-[32px] md:text-[64px] font-['Satoshi:Medium',sans-serif] border-[4px] md:border-[6px] border-white/40 shrink-0 z-10">
             {initials}
           </div>
           <div className="flex flex-col gap-1 md:gap-2 items-center md:items-start z-10">
             <h1 className="text-white text-[24px] md:text-[42px] font-['Satoshi:Medium',sans-serif] text-center md:text-left">{user.name}</h1>
             <div className="flex flex-col md:flex-row items-center md:flex-wrap gap-2 md:gap-6 text-white/90 text-[14px] md:text-[20px] font-['Satoshi:Regular',sans-serif]">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 items-start mb-[100px]">
          ...
          <div className="flex-1 w-full bg-white rounded-[16px] p-5 md:p-10 shadow-sm flex flex-col gap-6 md:gap-10">
            ...
            {activeTab === "My profile" && (
              <div className="flex flex-col gap-4 md:gap-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-[#1A1A1A] text-[24px] md:text-[30px] font-['Satoshi:Medium',sans-serif]">My Profile</h2>
                  <button
            ...
            {activeTab === "My Orders" && (
              <div className="flex flex-col gap-4 md:gap-6">
                <h2 className="text-[#1A1A1A] text-[24px] md:text-[30px] font-['Satoshi:Medium',sans-serif]">My Orders</h2>
                <div className="flex flex-col items-center justify-center py-12 md:py-20 text-center bg-[#f9f9f9] rounded-[12px] border border-dashed border-[#ccc]">
