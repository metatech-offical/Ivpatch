    ...
    <main className="bg-[#f2f2f2] min-h-screen px-[20px] py-[22px]">
      <div className="w-full max-w-[1252px] mx-auto flex flex-col gap-[20px] md:gap-[30px]">
        ...
        <section className="h-[520px] md:h-[725px] rounded-[16px] overflow-hidden relative shadow-sm">
          ...
          <div className="absolute top-[70px] left-1/2 -translate-x-1/2 w-full max-w-[600px] text-center z-10 px-6">
            <p className="text-white/70 text-[20px] md:text-[22px] font-['Satoshi:Medium',sans-serif] tracking-tight">
              A touch of Effortless nutrition
            </p>
            <h3 className="mt-4 text-white text-[36px] md:text-[40px] font-['Satoshi:Bold',sans-serif] leading-tight tracking-[-1px]">
              Where care meets comfort
            </h3>
            <button className="mt-10 mx-auto bg-white w-[163px] h-[52px] flex items-center justify-center rounded-[16px] text-[#1A1A1A] text-[20px] md:text-[24px] font-['Satoshi:Bold',sans-serif] shadow-lg transition-transform hover:scale-105 active:scale-95">
              Shop Now
            </button>
          </div>

          {/* Product Spotlight Pill */}
          <div className="absolute left-1/2 -translate-x-1/2 bottom-[100px] w-full max-w-[500px] md:max-w-[460px] h-[119px] rounded-[24px] border border-white/20 bg-black/30 backdrop-blur-[15px] p-[10px] z-10">
            <div className="flex items-center h-full w-full gap-5">
              {/* Image Box */}
              <div className="w-[119px] h-[99px] rounded-[18px] overflow-hidden bg-white flex shrink-0">
                <img src={SPOTLIGHT_IMAGE} alt="Product Spotlight" className="w-full h-full object-contain p-2" />
              </div>

              {/* Text Wrapper - Horizontal Layout */}
              <div className="flex flex-1 items-center justify-between pr-4 md:pr-6">
                <p className="text-white text-[18px] md:text-[22px] font-['Satoshi:Medium',sans-serif] tracking-wide">
                  NMN/NAD+
                </p>
                <p className="text-white text-[28px] md:text-[34px] font-['Satoshi:Medium',sans-serif]">
                  $94
                </p>
              </div>
            </div>
